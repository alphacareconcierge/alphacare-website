...
export default function AboutPage() {
  return (
    <div className="bg-ivory text-navy">
      <section className="grid grid-cols-1 border-b border-divider lg:min-h-[36.9375rem] lg:grid-cols-[43.25%_56.75%]">
        <div className="px-6 py-16 sm:px-12 lg:px-[4.1875rem] lg:pb-0 lg:pt-[4.375rem]">
          <p className="ac-eyebrow">
            About Alpha Care
          </p>
          <h1 className="ac-heading-1 mt-[2.3125rem] max-w-2xl">
            Care may involve many people.<br />
            <span className="inline-block italic">Families still experience all of it.</span>
          </h1>
          <span className="mt-[2.125rem] block h-px w-10 bg-gold/60" aria-hidden="true" />
          <p className="ac-body-copy mt-[2rem] max-w-xl">
        ...
        <div className="px-6 pb-16 sm:px-12 lg:px-[4.1875rem] lg:pb-0 lg:pt-[4.375rem]">
          <div className="relative aspect-[4/3] w-full min-h-[24rem] overflow-hidden rounded-sm border border-[#E3DBCF]/70 lg:aspect-auto lg:h-[31.25rem] lg:max-h-[31.25rem]">
            <Image
              src="/about-hero.png"
      ...
      <section className="px-6 py-14 text-center sm:px-12 lg:px-[4.3125rem] lg:py-16">
        <h2 className="ac-heading-2 mx-auto max-w-3xl italic">
        ...
        <p className="ac-body-copy mx-auto mt-3 max-w-2xl">
      ...
      <section className="grid gap-10 px-6 pb-20 sm:px-12 lg:grid-cols-[42%_58%] lg:gap-16 lg:px-[4.3125rem]">
        <div>
          ...
          <h2 className="ac-heading-2 mt-8 max-w-[28rem]">
        ...
        <div>
          {values.map((value) => (
            <article key={value.title} className="mb-6 border-b border-[#E3DBCF]/50 pb-6 last:mb-0 last:border-b-0 last:pb-0">
              ...
              <p className="ac-secondary-copy mt-1.5 max-w-md">
                {value.copy}
              </p>
            </article>
          ))}
