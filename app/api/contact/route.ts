...
function formatRow(label: string, value: string) {
  return `
    <tr>
      <th align="left" style="padding: 12px 16px; border-bottom: 1px solid #E3DBCF; color: #0B2239; font-family: 'Source Sans 3', Arial, sans-serif; font-size: 14px; vertical-align: top; width: 190px;">
        ${escapeHtml(label)}
      </th>
      <td style="padding: 12px 16px; border-bottom: 1px solid #E3DBCF; color: #6E6A63; font-family: 'Source Sans 3', Arial, sans-serif; font-size: 14px; line-height: 1.6; vertical-align: top;">
...
const acknowledgementHtml = `
  ...
  <div style="margin: 0; padding: 40px 20px; background: #F4EFEA;">
    <div style="max-width: 540px; margin: 40px auto; padding: 48px 40px; background: #F7F3EC; border: 1px solid #E3DBCF; box-shadow: 0 4px 20px rgba(11, 34, 57, 0.04);">
      <div style="text-align: center;">
        <div style="font-family: Newsreader, Georgia, serif; font-size: 18px; font-weight: 400; letter-spacing: 0.2em; line-height: 1.2; color: #0B2239; text-transform: uppercase;">
          ALPHACARE
        </div>
        <div style="margin-top: 4px; font-family: 'Source Sans 3', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; font-size: 10px; font-weight: 400; letter-spacing: 0.14em; line-height: 1.4; color: #B48A4A; text-transform: uppercase;">
          CONCIERGE CARE MANAGEMENT
        </div>
        <div style="width: 48px; border-top: 1px solid #B48A4A; margin: 24px auto;"></div>
      </div>

      <div style="font-family: 'Source Sans 3', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; font-size: 14.5px; font-weight: 300; line-height: 1.8; color: #6E6A63;">
        ...
        <div style="font-family: Newsreader, Georgia, serif; font-size: 16px; font-weight: 500; line-height: 1.3; color: #0B2239;">
          AlphaCare Concierge
        </div>
        <div style="margin-top: 4px; font-family: 'Source Sans 3', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; font-size: 11px; font-weight: 400; letter-spacing: 0.08em; line-height: 1.4; color: #B48A4A; text-transform: uppercase;">
          Private Concierge Care Management
        </div>
        <div style="margin-top: 4px; font-family: 'Source Sans 3', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; font-size: 11px; font-weight: 400; line-height: 1.4; color: #6E6A63;">
...
export async function POST(request: Request) {
  ...
  const html = `
    <div style="background: #F7F3EC; padding: 32px;">
      <div style="max-width: 680px; margin: 0 auto; background: #ffffff; border: 1px solid #E3DBCF;">
        <div style="padding: 24px 28px; border-bottom: 2px solid #B48A4A;">
          <p style="margin: 0 0 8px; color: #B48A4A; font-family: 'Source Sans 3', Arial, sans-serif; font-size: 12px; font-weight: 700; letter-spacing: 0.12em; text-transform: uppercase;">
            AlphaCare Concierge
          </p>
          <h1 style="margin: 0; color: #0B2239; font-family: Newsreader, Georgia, serif; font-size: 28px; font-weight: 400; line-height: 1.25;">
            New Website Inquiry
          </h1>
        </div>
