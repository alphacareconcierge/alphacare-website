...
export default function NotFound() {
  return (
    <section className="mx-auto max-w-3xl bg-ivory px-6 py-24 text-center sm:px-8">
      ...
      <Link
        href="/"
        className="type-cta mt-8 inline-flex min-h-11 items-center justify-center rounded-[0.25rem] bg-navy px-6 py-3 text-gold transition hover:bg-navy/95 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-gold"
      >
        Return Home
      </Link>
    </section>
